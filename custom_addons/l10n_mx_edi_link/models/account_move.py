...
class AccountMove(models.Model):
    ...
    def action_open_associate_cfdi_wizard(self):
        ...
        'custom_l10n_mx_edi_link.associate_cfdi_wizard' para que el usuario
        ...
        # Busca la definición de la vista de formulario del wizard por su XML ID completo.
        wizard_form_view_id = self.env.ref('custom_l10n_mx_edi_link.view_custom_l10n_mx_edi_link_associate_cfdi_wizard_form').id
        ...
        return {
            ...
            'res_model': 'custom_l10n_mx_edi_link.associate_cfdi_wizard', # El modelo del wizard a instanciar
            ...
            'context': self.env.context,               # Pasa el contexto actual. Odoo añade automáticamente 'active_id',
                                                       ...
                                                       # No necesitamos añadir 'default_move_id' explícitamente aquí
                                                       # si el wizard usa context.get('active_id').
        }

# Nota: No se añaden campos nuevos a account.move en este archivo,
# solo se añade el método de acción.
