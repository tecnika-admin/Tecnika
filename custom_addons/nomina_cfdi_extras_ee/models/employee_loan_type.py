...
class employee_loan_type(models.Model):
    ...
    loan_limit = fields.Float('Límite del monto del deducción', default=5000, required=True)
    loan_term = fields.Integer('Plazo de la deducción', default=12, required=True)
    ...
    tipo_deduccion = fields.Selection([('1','Préstamo'), 
                                       ...
                                       ('16','Descuento periodico 15'),], string='Tipo de deducción', required=True)
